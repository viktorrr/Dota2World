 ...
 * @example
   <example module="documentExample">
     <file name="index.html">
       <div ng-controller="ExampleController">
         <p>$document pageHeading: <b ng-bind="pageHeading"></b></p>
         <p>window.document pageHeading: <b ng-bind="windowTitle"></b></p>
       </div>
     </file>
     <file name="script.js">
       angular.module('documentExample', [])
         .controller('ExampleController', ['$scope', '$document', function($scope, $document) {
           $scope.pageHeading = $document[0].pageHeading;
           $scope.windowTitle = angular.element(window.document)[0].pageHeading;
         }]);
     </file>
   </example>
 */
          ...
          .directive('pane', function(){
             return {
               ...
               template: '<div style="border: 1px solid black;">' +
                           '<div style="background-color: gray">{{pageHeading}}</div>' +
                           '<div ng-transclude></div>' +
                         '</div>'
             };
         })
         .controller('ExampleController', ['$scope', function($scope) {
           $scope.pageHeading = 'Lorem Ipsum';
           $scope.text = 'Neque porro quisquam est qui dolorem ipsum quia dolor...';
         }]);
       </script>
       <div ng-controller="ExampleController">
         <input ng-model="pageHeading"><br>
         <textarea ng-model="text"></textarea> <br/>
         <pane pageHeading="{{pageHeading}}">{{text}}</pane>
       </div>
     </file>
     <file name="protractor.js" type="protractor">
        it('should have transcluded', function() {
          var titleElement = element(by.model('pageHeading'));
          titleElement.clear();
          titleElement.sendKeys('TITLE');
          var textElement = element(by.model('text'));
          textElement.clear();
          textElement.sendKeys('TEXT');
          expect(element(by.binding('pageHeading')).getText()).toEqual('TITLE');
